...
export const auth = $root.auth = (() => {
    ...
    auth.v1 = (function() {
        ...
        v1.LoginResponse = (function() {
             ...
             * @property {number|null} [expiresInt] LoginResponse expiresInt
             */
            ...
            /**
             * LoginResponse expiresInt.
             * @member {number} expiresInt
             * @memberof auth.v1.LoginResponse
             * @instance
             */
            LoginResponse.prototype.expiresInt = 0;
            ...
            LoginResponse.encode = function encode(message, writer) {
                ...
                if (message.expiresInt != null && Object.hasOwnProperty.call(message, "expiresInt"))
                    writer.uint32(/* id 2, wireType 0 =*/16).int32(message.expiresInt);
                return writer;
            };
            ...
            LoginResponse.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        message.expiresInt = reader.int32();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            LoginResponse.verify = function verify(message) {
                ...
                if (message.expiresInt != null && message.hasOwnProperty("expiresInt"))
                    if (!$util.isInteger(message.expiresInt))
                        return "expiresInt: integer expected";
                return null;
            };
            ...
            LoginResponse.fromObject = function fromObject(object) {
                ...
                if (object.expiresInt != null)
                    message.expiresInt = object.expiresInt | 0;
                return message;
            };
            ...
            LoginResponse.toObject = function toObject(message, options) {
                ...
                if (message.expiresInt != null && message.hasOwnProperty("expiresInt"))
                    object.expiresInt = message.expiresInt;
                return object;
            };
